    ...
    <>
      ...
      <button className="btn btn-outline-primary" onClick = {()=> setUserType('student')}> Student </button> 
                    ...
                    <form className="form-control" onSubmit={handleSubmit}>
                        <label className="text-successs" htmlFor="rollNo">Username: </label>
                        ...
                        <label className="text-successs" htmlFor="password">Password: </label>
                        <div className="input-group flex-nowrap">
                        <input type="password" id="password"
                            name="password" className="form-control" placeholder="Password" aria-labelledby="passwordHelpBlock" value={input.password}
